...
<div class="mx-auto max-w-[1400px]">
    ...
    <!-- Toolbar Row 1: Actions + Undo/Redo -->
    <div class="mb-2 flex flex-wrap items-center gap-3">
        ...
        <div class="flex gap-1">
            <button class="flex h-9 cursor-pointer items-center rounded-sm border border-gray-400 bg-transparent px-2.5 text-xs text-gray-1000 transition-colors hover:bg-gray-100" id="editor-undo" title="Undo (Cmd+Z)">${icon('cornerUpLeft', 16)}</button>
            <button class="flex h-9 cursor-pointer items-center rounded-sm border border-gray-400 bg-transparent px-2.5 text-xs text-gray-1000 transition-colors hover:bg-gray-100" id="editor-redo" title="Redo (Cmd+Shift+Z)">${icon('cornerUpRight', 16)}</button>
        </div>
