...
(function(root) {
    ...
    const CUBE_VALUES = Object.freeze([0, 95, 135, 175, 215, 255]);

    // Standard 16 colors (VGA palette)
    const STANDARD_16 = Object.freeze([
     ...
     */
    function findNearest(r, g, b, metric = 'manhattan') {
        const distFn = metric === 'euclidean' ? colorDistanceEuclidean : colorDistanceManhattan;
     ...
     */
    function isGrayscale(r, g, b, threshold = 5) {
     ...
     */
    function fgEscapeString(index) {
        return `\\e[38;5;${index}m`;
    }

    function bgEscapeString(index) {
