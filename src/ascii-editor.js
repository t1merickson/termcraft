...
(function(root) {
    ...
    function create(canvas, opts = {}) {
        ...
        // Grid state: 2D array of { char, fg }
        ...
        // Tool state
        let tool = 'type'; // 'type', 'brush', 'fill', 'eraser', 'line'
        let brushChar = '#';
        let brushFg = null; // null = default (white)

        // Line tool state
        let lineStart = null; // { col, row } or null

        // Undo/redo stacks (cell diffs)
        const undoStack = [];
        const redoStack = [];
        const MAX_UNDO = 200;
        ...
        canvas.addEventListener('mousemove', (e) => {
            ...
            // Paint along the path using Bresenham
            const diffs = [];
        ...
        function handleKeyDown(e) {
            ...
            // Printable characters (type mode)
